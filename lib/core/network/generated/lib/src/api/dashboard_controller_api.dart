...
class DashboardControllerApi {
  ...
  Future<Response<BuiltList<Payment>>> getTotalIncome({ 
    ...
    final _path = r'/api/dashboard/total-income';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> getTotalMentor({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/dashboard/total-mentor';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> getTotalSession({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/dashboard/total-session';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [int] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> getTotalUser({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/dashboard/total-user';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
