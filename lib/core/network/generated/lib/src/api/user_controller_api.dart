...
import 'package:inblue_api/src/model/user_info.dart';
import 'package:inblue_api/src/model/user_response.dart';
...
class UserControllerApi {
  ...
  Future<Response<UserResponse>> changePassword({ 
    ...
    final _path = r'/api/users/change-password';
    ...
    final _queryParameters = <String, dynamic>{
      r'oldPass': encodeQueryParameter(_serializers, oldPass, const FullType(String)),
      r'newPass': encodeQueryParameter(_serializers, newPass, const FullType(String)),
    };
  ...
  Future<Response<User>> createUser({ 
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        r'data': encodeFormParameter(_serializers, data, const FullType(UserInfo)),
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> getUserResponseById({ 
    required int userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/users/find-by-id/{userId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CandidateProfile>> uploadCv({ 
    ...
    final _path = r'/api/users/upload-cv';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
