...
import 'package:inblue_api/src/model/payment.dart';
import 'package:inblue_api/src/model/webhook.dart';
...
class PaymentControllerApi {
  ...
  Future<Response<Payment>> cancelPayment({ 
    ...
    final _path = r'/api/payments/cancel';
    ...
    final _queryParameters = <String, dynamic>{
      r'transactionCode': encodeQueryParameter(_serializers, transactionCode, const FullType(String)),
    };
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> createPayment({ 
    required int jdId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/payments/pay';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Payment>> getPayment({ 
    ...
    final _path = r'/api/payments/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Payment>>> getPayments({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> handlePayOsWebhook({ 
    ...
    final _path = r'/api/payments/webhook';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
